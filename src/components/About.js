    ...
    <div className={`${classes.root}`}>
      <ThemeProvider theme={theme}>
        ...
        <Typography
          variant="h3"
          color="initial"
          style={{ fontFamily: "Montserrat", margin: "2rem 40px 0 40px " }}
        >
          Sibteali Baqar
        </Typography>
        <div
        ...
        <Typography
          ...
          color="initial"
          align="center"
          style={{ fontFamily: "Montserrat", margin: "5px 40px 20px 40px" }}
        >
          <span style={{ fontWeight: "700" }}>Syed Sibteali Baqar </span>is a
          tech enthusiastic whether it concern developing a project, Taking care
          of How it appears (Graphics Designing or Visualization) or How much
          secure it will be (Cybersecurity). A Computer Engineering student at
          NUST. He is interested to work as a{" "}
          ...
          . Sibteali Baqar also loves to get involved in Communities and thus is
          a part of{" "}
          <span style={{ fontWeight: "700" }}>
            {" "}
            Google Developer Club and a Deputy Director for Graphics Designing
            of Tarteel ( A literature Society in EME,NUST ).{" "}
          </span>
        </Typography>
      </ThemeProvider>
    </div>
